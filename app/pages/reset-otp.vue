...
const handleResetOtp = async () => {
  try {
    await auth.verifyResetOtp({ email: email.value, otp: otp.value });
    ...
    >
      ...
      <div class="flex flex-col justify-start items-start">
        <div class="space-y-3 mb-8">
          ...
          />
          <Text
            text="Please enter the email and get the new otp for reset password"
            size="xs"
            color="secondary"
            class="lg:pr-20"
          />
